...
export function main() {
  ...
  // =========================================================================
  createLabel('PBR metallic property (0=plastic, 1=metal)', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  for (let i = 0; i <= 10; i++) {
    const metallic = i / 10
    ...
    createLabel(`metallic=${metallic.toFixed(1)}`, Vector3.create(x, yPos + 1, rowZ), labelSize)
  }
  ...
  // =========================================================================
  createLabel('PBR roughness property (0=smooth, 1=matte)', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  for (let i = 0; i <= 10; i++) {
    ...
    createLabel(`roughness=${roughness.toFixed(1)}`, Vector3.create(x, yPos + 1, rowZ), labelSize)
  }
  ...
  // =========================================================================
  createLabel('PBR emissiveIntensity (glow strength)', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  ...
  emissiveIntensities.forEach((intensity, i) => {
    ...
    createLabel(`emissiveIntensity=${intensity}`, Vector3.create(x, yPos + 1, rowZ), labelSize)
  })
  ...
  // =========================================================================
  createLabel('PBR specularIntensity (highlight strength)', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  for (let i = 0; i <= 10; i++) {
    const specular = i / 10
    const x = baseX - 10 + i * spacing
    ...
    createLabel(`specularIntensity=${specular.toFixed(1)}`, Vector3.create(x, yPos + 1, rowZ), labelSize)
  }
  ...
  // =========================================================================
  createLabel('PBR albedoColor alpha (opacity)', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  for (let i = 0; i <= 10; i++) {
    const alpha = i / 10
    const x = baseX - 10 + i * spacing
    ...
    createLabel(`alpha=${alpha.toFixed(1)}`, Vector3.create(x, yPos + 1, rowZ), labelSize)
  }
  ...
  // =========================================================================
  createLabel('PBR transparencyMode', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  ...
  transparencyModes.forEach((tm, i) => {
    ...
    createLabel(`transparencyMode=\n${tm.name}`, Vector3.create(x, yPos + 1.3, rowZ), labelSize)
  })
  ...
  createLabel('bumpTexture=\nnone', Vector3.create(baseX + 8, yPos + 1.3, rowZ), labelSize)
  ...
  createLabel('bumpTexture=\nnormal_map.png', Vector3.create(baseX + 12, yPos + 1.3, rowZ), labelSize)
  ...
  // =========================================================================
  createLabel('UNLIT Material.setBasicMaterial()', Vector3.create(baseX - 22, yPos + 0.5, rowZ), labelSize)
  ...
  unlitColors.forEach((c, i) => {
    ...
    createLabel(c.name, Vector3.create(x, yPos + 1.2, rowZ), labelSize)
  })
  ...
  createLabel('diffuseColor +\nalphaTexture', Vector3.create(baseX + 8, yPos + 1.3, rowZ), labelSize)
  ...
  createLabel('texture +\nalphaTexture\n(plane mesh)', Vector3.create(baseX + 12, yPos + 1.5, rowZ), labelSize)
